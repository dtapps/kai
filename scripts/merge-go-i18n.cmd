@echo off
REM 合并 Go 后端 i18n 拆分文件到主文件（Windows 版本）
REM 用法: scripts\merge-go-i18n.cmd

setlocal enabledelayedexpansion

set "SPLIT_DIR=%~dp0..\internal\i18n\locales\split"
set "LOCALES_DIR=%~dp0..\internal\i18n\locales"
